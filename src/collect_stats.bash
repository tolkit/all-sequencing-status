...
ls /lustre/scratch116/tol/projects/darwin/data/{algae,amphibians,annelids,arthropods,birds,chordates,dicots,echinoderms,fish,fungi,insects,jellyfish,mammals,molluscs,monocots,nematodes,non-vascular-plants,other-animal-phyla,platyhelminths,protists,sharks,sponges,vascular-plants}/*/assembly/release/reference 2>/dev/null | \
grep "lustre" | \
...
# Genomic data
ls /lustre/scratch116/tol/projects/darwin/data/{algae,amphibians,annelids,arthropods,birds,chordates,dicots,echinoderms,fish,fungi,insects,jellyfish,mammals,molluscs,monocots,nematodes,non-vascular-plants,other-animal-phyla,platyhelminths,protists,sharks,sponges,vascular-plants}/*/genomic_data/*/*/ | \
grep "lustre" | \
